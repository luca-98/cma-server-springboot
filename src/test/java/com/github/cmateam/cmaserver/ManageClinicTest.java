...
public class ManageClinicTest extends CmaBaseTest {
	...
	@Test
	void printForm() throws Exception {
		mockMvc.perform(get("/print-form").header(HttpHeaders.AUTHORIZATION, token).accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
	}

	@Test
	void printFormNotAuthen() throws Exception {
		mockMvc.perform(get("/print-form").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON))
